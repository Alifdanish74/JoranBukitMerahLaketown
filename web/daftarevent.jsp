    ...
    <div class="container">
        ...
        <main>
                <header class="row tm-welcome-section">
                    <h2 class="col-12 text-center tm-section-title">Tournament Registration</h2>
                </header>
                    <% String ID = request.getParameter("id"); %>
                <div class="tm-container-inner-2 tm-contact-section">
                    <form action="DaftarEventServlet" method="post">
                    ...
                    <c:forEach var="row" items="${result.rows}">
                        ...
                        <header class="row tm-welcome-section">
                            <h2 style="text-align: center;" class="text-center">${row.eventname}</h2>
                    <input type="hidden" name="eventname" value="${row.eventname}"/>
                        ...
                        <div class="form-group">
                            <input type="number" min="1" style="width: 200px;" name="rod" class="form-control" placeholder="No of fishing rod" required=""/>
                        </div>
                            <td><span style="color:red"><%=(request.getAttribute("errMessage") == null) ? ""
                                        : request.getAttribute("errMessage")%></span></td>
