    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="tm-paging-links">
                <nav>
                    <ul>
                        <li class="tm-paging-item"><a href="Home.jsp" class="tm-paging-link">Fishing Tournament</a></li>
                        <li class="tm-paging-item"><a href="pondhome.jsp" class="tm-paging-link active">Booking Pond</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="row tm-gallery">
                ...
                <div id="tm-gallery-page-event" class="tm-gallery-page">
                    ...
                    <article class="card col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
                        <figure>
                            <img src="getImagePond.jsp?id= ${row.id}"  class="img-fluid tm-gallery-img"/> 
                         <!--   <img src="img/gallery/pond1.jpg" alt="Image" class="img-fluid tm-gallery-img" /> -->
                            <figcaption>
                                
                                <h4 class="tm-gallery-title"><c:out value="${row.pondname}"/></h4>
                                <p class="tm-gallery-description text-align:center"><c:out value="${row.description}"/></p>
                                <p class="tm-gallery-description">Fee (per hour): RM<c:out value="${row.fee}"/></p>
                                <a href="daftarkolam.jsp?id=${row.id}"><button class="button" ><span>Booking</span></button></a>
                            </figcaption>
                        </figure>
                    </article>
                        </div>
