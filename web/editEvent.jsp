        ...
        <div class="container">
            ...
            <main>
                <header class="row tm-welcome-section">
                    <h2 class="col-12 text-center tm-section-title">Edit Tournament Event</h2>
                </header>
                ...
                <div id="event-container">
                        ...
                        <form style="width:700px" action="UpdateEventServlet" method="post" enctype="multipart/form-data">
                            ...
                            <c:forEach var="row" items="${result.rows}">
                                ...
                                <tr>
                                    <td>Event Name</td>
                                    <td><input type="text" name="eventname" value="${row.eventname}" required=""/></td> 
                                </tr>  
                                <tr>
                                    <td>Description</td>
                                  </textarea><input type="text" name="description" value="${row.description}" required="" style="height:100px"></textarea>
                                </tr>
                                <br>
                                <tr>
                                    <td>Image</td>
                                ...
                                <tr>
                                    <td>Event Date</td>
                                    <td><input type="date" name="eventdate" value="${row.eventdate}" required=""</td>
                                </tr>
                                <br><br>
                                <tr>
                                    <td>Location</td>
