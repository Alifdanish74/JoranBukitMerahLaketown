        ...
        <div class="container">
            ...
            <main>
                ...
                <header class="row tm-welcome-section">
                    ...
                    <h2 class="col-12 text-center tm-section-title">View List of Fishing Pond Booking</h2>
                </header>
                
                <div class="tm-container-inner-2 tm-contact-section">   
                   
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for fishing pond names.." title="Type in a name">
                     
                 <table id="event">
                     <sql:query var="result" dataSource="${myDatasource}">
                        SELECT * FROM DAFTARKOLAM
                    </sql:query>
                    <tr>
                            <th style="width:10px">ID</th>
                            <th style="width:150px">POND NAME</th>
