...
<html>
    ...
    <head>
        ...
        <a href="signin.jsp" class="closebtnx" onclick="this.parentElement.style.display='none';">&times;</a>
    ...
    <div class="wrapper fadeInDown">
        ...
        <b style="color:red" > ADMIN LOGIN</b></h1>
        <div id="formContent">
            <!-- Tabs Titles -->
            <h2> <a href="adminlogin.jsp" class="active"> Log In </a></h2>
            <h2> <a href="adminregister.jsp" class="inactive underlineHover">Sign Up </a></h2>
  ...
  <span class="closebtn" onclick="this.parentElement.style.display='none';"><strong><%=(request.getAttribute("errMessage") == null) ? ""
            ...
            <!-- Remind Passwwrd -->
            <div id="formFooter">
                <a class="underlineHover" href="adminregister.jsp">Forgot Password?</a>
            </div>
