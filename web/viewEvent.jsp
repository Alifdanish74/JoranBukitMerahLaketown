        ...
        <div class="container">
            ...
            <main>
                ...
                <header class="row tm-welcome-section">
                    ...
                    <h2 class="col-12 text-center tm-section-title">Enter Tournament Event</h2>
                </header>
                
                <!-- Edit Event Form -->
                    <div id="event-container">
                        <form style="width:700px" action="EditEventServlet" method="post" enctype="multipart/form-data">
                            
                            <label for="eventname">Event Name</label>
                            <input type="text" id="eventname" name="eventname" placeholder="Event Name..">
                            
                            <label for="desc">Description</label>
                            <textarea id="desc" name="desc" placeholder="Description.." style="height:100px"></textarea>
                            
                            <label for="image">Image</label>
                            <input type="file" id="image" name="image" accept="image/png, image/gif, image/jpeg">
                            <br><br>    
                            <label for="tarikh">Event Date</label>
                 ...
                 <table id="event">
                    ...
                    <c:forEach var="row" items="${result.rows}">
                            <tr>
                                ...
                                <td> <img src="DisplayImageServlet?id= ${row.id}" width="150px" height="150px"/></td>
                                <td><a href="editEvent.jsp?id=${row.id}"><input type="submit" value="Edit" /></a></td>
                                <td><a href="deleteEvent.jsp?id=${row.id}"><input type="submit" value="Delete" /></a></td>
