...
public class UpdateEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String tarikh = request.getParameter("eventdate");
        ...
        updateeventBean.setID(id);
        updateeventBean.setEventname(eventname);
        updateeventBean.setEventDesc(description);
        updateeventBean.setLocation(location);
        updateeventBean.setTarikh(eventDate);
        ...
        if(image != null){
            ...
            updateeventBean.setImage((Part) image);

        }
        
        UpdateEventDao updateeventDao = new UpdateEventDao();
        String eventRegistered = "null";
        
        try{
            eventRegistered = updateeventDao.updateEvent(updateeventBean);
        }catch(ClassNotFoundException ex){
            Logger.getLogger(EditEventServlet.class.getName()).log(Level.SEVERE,null,ex);
        }
        if(eventRegistered.equals("SUCCESS")){
            request.setAttribute("errMessage", "You have successfully edited an event");
    ...
    /**
     * Returns a short description oftry{
            eventRegistered = updateeventDao.updateEvent(updateeventBean);
        }catch(ClassNotFoundException ex){
            Logger.getLogger(EditEventServlet.class.getName()).log(Level.SEVERE,null,ex);
        }
