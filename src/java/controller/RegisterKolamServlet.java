 ...
 * FOR LAKETOWN
 */
public class RegisterKolamServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RegisterKolamDao registerDao = new RegisterKolamDao();
        ...
        if(userRegistered.equals("SUCCESS")){
            request.setAttribute("errMessage", "You have successfully registered");
