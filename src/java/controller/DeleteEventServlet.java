...
public class DeleteEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         updateEventBean deleteeventBean = new updateEventBean();
         deleteeventBean.setID(id);
         
         DeleteEventDao deleteeventDao = new DeleteEventDao();
         String eventRegistered = "null";
        
        try{
            eventRegistered = deleteeventDao.deleteEvent(deleteeventBean);
        }catch(ClassNotFoundException ex){
            Logger.getLogger(DeleteEventServlet.class.getName()).log(Level.SEVERE,null,ex);
        }
        if(eventRegistered.equals("SUCCESS")){
            request.setAttribute("errMessage", "You have successfully delete an event");
